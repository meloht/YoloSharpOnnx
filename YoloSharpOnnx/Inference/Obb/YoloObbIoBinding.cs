...
{
    internal class YoloObbIoBinding: YoloObbBase, IYoloObb
    {
        ...
        public YoloObbIoBinding(InferenceSession session, SessionOptions options, IObbPostprocess postprocess, IDetPreprocess preprocess, OnnxModel onnxModel, YoloConfig config)
        ...
        public List<ObbResult> Run(Mat inputImage)
        {
            // 预处理图像
        ...
        public YoloResult<ObbResult> RunWithTime(Mat inputImage)
        {
            ...
            return new YoloResult<ObbResult>(res, speed);
        }
