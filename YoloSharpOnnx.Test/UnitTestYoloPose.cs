...
namespace YoloSharpOnnx.Test
{
    public class UnitTestYoloPose: IDisposable
    {
        ...
        public UnitTestYoloPose()
        {
            ...
            yolo11n = new YoloSharp(new ExecutionProviderCPU(TestDataUtils.GetModelPath("yolo11n-pose.onnx")));
            yolo8n = new YoloSharp(new ExecutionProviderCPU(TestDataUtils.GetModelPath("yolov8n-pose.onnx")));
            yolo26n = new YoloSharp(new ExecutionProviderCPU(TestDataUtils.GetModelPath("yolo26n-pose.onnx")));
        }
