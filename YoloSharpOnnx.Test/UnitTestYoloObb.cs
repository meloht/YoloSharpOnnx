...
namespace YoloSharpOnnx.Test
{
    public class UnitTestYoloObb: IDisposable
    {
        ...
        public UnitTestYoloObb()
        {
            ...
            yolo11n = new YoloSharp(new ExecutionProviderCPU(TestDataUtils.GetModelPath("yolo11n-obb.onnx")));
            yolo8n = new YoloSharp(new ExecutionProviderCPU(TestDataUtils.GetModelPath("yolov8n-obb.onnx")));
            yolo26n = new YoloSharp(new ExecutionProviderCPU(TestDataUtils.GetModelPath("yolo26n-obb.onnx")));
        }
