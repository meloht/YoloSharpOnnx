...
namespace YoloSharpOnnx.Test
{
    public class UnitTestYoloSegment : IDisposable
    {
        ...
        public UnitTestYoloSegment()
        {
            ...
            yolo11n = new YoloSharp(new ExecutionProviderCPU(TestDataUtils.GetModelPath("yolo11n-seg.onnx")));
            yolo8n = new YoloSharp(new ExecutionProviderCPU(TestDataUtils.GetModelPath("yolov8n-seg.onnx")));
            yolo26n = new YoloSharp(new ExecutionProviderCPU(TestDataUtils.GetModelPath("yolo26n-seg.onnx")));
        }
